...
int main(void) {
  ...
  window = glfwCreateWindow(1024, 768, "Tutorial 04 - Colored Cube", nullptr,
                            nullptr);
  if (window == nullptr) {
    std::cerr
  ...
  static const std::vector<glm::vec3> g_color_buffer_data = {
  ...
  const model_ns::vbo_type<glm::vec3> colorbuffer{g_color_buffer_data};
  ...
  do {
    ...
    const model_ns::render_state_type render_states_colorbuffer =
        colorbuffer.render(1);
